...
Linkage disequilibrium (LD, non-independent co-inheritance) of the loci included in the PMR estimation will bias the results. The non-independence of loci will leas to underestimation of the variance (standard error) of the PMR and hence falsely inflate the confidence of relatedness estimates. Moreover, large shared blocks packed with unpruned SNPs will artificially pull down the overall PMR making individuals look more related than they are, while dense regions of high local diversity will artificially push the PMR up making individuals look less related. \
