...
![**Fig 1.** Generation links count for the coefficient of relationship calculation. A) Number of links between two siblings comprises two links through the mother (red) and two links through the father (green). B) Number of links between a person and their aunt comprises three links through the shared grandmother/mother (red) and three through the shared grandfather/father (green).](CoefficientOfRelationship.png){fig-align="center" width="60%"}
...
![**Figure 3.** Outline of the general READ workflow to estimate the degree of relationship between two individuals. From [@Monroy_Kuhn2018-fb]](READ1.JPG){fig-align="center", width="80%"}
...
![**Figure 4.** READv2 flowchart. From [@Alacamli2024-xq]](Alacamli.F5.Folwchart.jpg){fig-align="center", width="80%"}
