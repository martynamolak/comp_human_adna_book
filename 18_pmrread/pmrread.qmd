...
$$ where $L$ is the numbers of generation links between two individuals ($i$ and $j$). E.g. full siblings are linked by two links through the mother (siblingA - mother - siblingB) and two links through the father (siblingA - father - siblingB), therefore the coefficient of relationship between them is $r = (^1/_2)^2 + (^1/_2)^2 = (^1/_4) + (^1/_4) = (^1/_2)$ (**Figure 1A**), while e.g. a person with their aunt are linked by three links through the shared grandmother/mother and three through the shared grandfather/father, so $r=(^1/_2)^3 + (^1/_2)^3 = (^1/_8) + (^1/_8) = (^1/_4)$ (**Figure 1B**).

![**Fig 1.** Generation links for the coefficient of relationship calculation. A) Number of links between two siblings comprises two links through the mother (red) and two links through the father (green). B) Number of links between a person and their aunt comprises three links through the shared grandmother/mother (red) and three through the shared grandfather/father (green).](CoefficientOfRelationship.png){fig-align="center" width="500"}
...
![**Table 1.** Values of the coefficient of relatedness and the kinship coefficient for different pedigree relationships up to the second-degree, assuming that $C_I$ = 0. From Rohrlach et al. [-@Rohrlach2023.04.17.537144].](CoefficientsOfRelatednessAndKinship.JPG){fig-align="center"}
...
![**Figure 2.** Outline of the general READ workflow to estimate the degree of relationship between two individuals. From [@Monroy_Kuhn2018-fb]](READ1.JPG){fig-align="center"}
...
![**Figure 3.** READv2 flowchart. From [@Alacamli2024-xq]](Alacamli.F5.Folwchart.jpg){fig-align="center"}
